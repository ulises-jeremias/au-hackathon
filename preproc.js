...
const codeEditableTemplate = (code, lang = 'bash') => (`<pre><code class='lang-${lang} hljs' data-trim contenteditable>${escapeHtml(code)}
</code></pre>`)

const codeTemplate = (code, lang = 'bash') => (`\`\`\`${lang}
${code}
\`\`\``)
